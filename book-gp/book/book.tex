...
\newcommand{\chessdiagramfivebyfive}[1]{%
\unitlength=.005truecm
\begin{picture}(520,520)(-10,-10)\small
% draw the board
\linethickness{.1mm}
%\put(0,0){\grid(500,500)(100,100)}
\put(0,0){\grid(500,500)(500,500)}
\linethickness{.3mm}
\put(-9,-9){\grid(518,518)(518,518)}
%
\chess@x=0\chess@y=0\chess@grey
%
\chess@x=0\chess@y=200\chess@grey
\chess@x=100\chess@y=100\chess@grey
\chess@x=200\chess@y=0\chess@grey
%
\chess@x=0\chess@y=400\chess@grey
\chess@x=100\chess@y=300\chess@grey
\chess@x=200\chess@y=200\chess@grey
\chess@x=300\chess@y=100\chess@grey
\chess@x=400\chess@y=0\chess@grey
%
\chess@x=200\chess@y=400\chess@grey
\chess@x=300\chess@y=300\chess@grey
\chess@x=400\chess@y=200\chess@grey
%
\chess@x=400\chess@y=400\chess@grey
%
#1
\end{picture}}

\newfont\achessfont{fselch10}% scaled 1000}
\newfont\bchessfont{fselch11}% scaled 1000}

\chessdiagramfivebyfive{
\put(100,100){\makebox(100,100){\color{white}\bchessfont\char12}}\put(100,100){\makebox(100,100){\achessfont\char0}}
\put(0,100){\makebox(100,100){\color{white}\bchessfont\char12}}\put(0,100){\makebox(100,100){\achessfont\char12}}
\put(0,0){\makebox(100,100){\color{white}\bchessfont\char13}}\put(0,0){\makebox(100,100){\achessfont\char1}}
\put(200,200){\makebox(100,100){\color{white}\bchessfont\char12}}\put(200,200){\makebox(100,100){\achessfont\char12}}
}
