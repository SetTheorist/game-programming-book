...
\newfont\ahfont{ahchess}{\ahfont ABCDOPQRSTabcdopqrst}
...
\tikzcongoboard{%
\foreach\x in {1,...,7} {
    \draw(\x,1)+(-0.5,0.5)node[white]{\ahfont o}node[black]{\ahfont O};
    \draw(\x,5)+(-0.5,0.5)node[black]{\ahfont q};
}
\draw(2,2)+(0.5,0.5)node[red!50!white]{\ahfont p}node[black]{\ahfont P};
\draw(1,3)+(0.5,0.5)node[black]{\ahfont o};
\draw(4,4)+(0.5,0.5)node[white]{\ahfont q}node[black]{\ahfont Q};
\draw(6,3)+(0.5,0.5)node[white]{\ahfont r}node[black]{\ahfont R};
\draw(6,4)+(0.5,0.5)node[white]{\ahfont b}node[black]{\ahfont A};
\draw(5,4)+(0.5,0.5)node[white]{\ahfont b}node[black]{\ahfont a};
\draw(1,0)+(0.5,0.5)node[white]{\ahfont d}node[black]{\ahfont C};
\draw(2,0)+(0.5,0.5)node[white]{\ahfont d}node[black]{\ahfont c};
}
