...
trait GameSide {
    ...
    pub fn other(self) -> Self;
    pub fn isnull(self) -> boolean;
    pub fn nullmove() -> Self;
}
trait GameMove {
}
trait GameBoard<Side:GameSide, Move:GameMove> {
    pub fn new() -> Self;
    pub fn reset(&mut self);
    pub fn make_move(&mut self, m: Move) -> Option<Side>;
    pub fn unmake_move(&mut self, m: Move) -> Option<Side>;
}
trait GameEvaluator<Board:GameBoard> {
    type Scale:Eq,Ord,PartialEq,PartialOrd;
}
trait Game {
