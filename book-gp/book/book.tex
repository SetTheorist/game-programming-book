...
\tikzchessboard{8}{12}{blue}{%
    ...
    \draw(2,0)+(0.5,0.5)node[yellow]{\dragonfont\char30}node[black]{\dragonfont\char31};%griffon
    ...
    %%%%
    \foreach\x in {0,2,4,6,8,10} {%
        \draw(\x,6)+(0.5,0.5)node[red]{\dragonfont\char0}node[black]{\dragonfont\char1};%sylph
    }%
    \draw(2,7)+(0.5,0.5)node[red]{\dragonfont\char30}node[black]{\dragonfont\char31};%griffon
    \draw(6,7)+(0.5,0.5)node[red]{\dragonfont\char15}node[black]{\dragonfont\char16};%dragon
...
\tikzchessboard{8}{12}{green}{%
    ...
    \draw(4,7)+(0.5,0.5)node[red]{\dragonfont\char24}node[black]{\dragonfont\char25};%cleric
    \draw(5,7)+(0.5,0.5)node[red]{\dragonfont\char12}node[black]{\dragonfont\char13};%mage
    \draw(6,7)+(0.5,0.5)node[red]{\dragonfont\char21}node[black]{\dragonfont\char22};%king
    \draw(7,7)+(0.5,0.5)node[red]{\dragonfont\char3}node[black]{\dragonfont\char4};%paladin
