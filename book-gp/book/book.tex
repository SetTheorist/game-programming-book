...
{\newfont\ahfont{ahchess scaled 2000}{\ahfont
\ \\
\char0\char1\char2 \\
\char3\char4\char5 \\
\char6\char7\char8 \\
...
\char42\char43\char44 \\
\char45\char46\char47 \\
\char48\char49\char50 \\
\char51\char52\char53 \\
\char54\char55\char56 \\
\char57\char58\char59 \\
\char60\char61\char62 \\
\char63\char64\char65 \\
\char66\char67\char68 \\
}}
\newfont\ahfont{ahchess scaled 1200}{\ahfont
\ \\
\char0\char1\char2 \\
\char3\char4\char5 \\
\char6\char7\char8 \\
...
\newfont\dragonfont{dragonchess scaled 1200}{\dragonfont
\ \\
\char0\char1\char2 \\
\char3\char4\char5 \\
\char6\char7\char8 \\
...
\tikzchessboard{8}{12}{blue}{%
    \foreach\x in {0,2,4,6,8,10} {%
        \draw(\x,1)+(0.5,0.5)node[yellow]{\dragonfont\char0}node[black]{\dragonfont\char1};%sylph
    }%
    \draw(1,0)+(0.5,0.5)node[yellow]{\dragonfont\char30}node[black]{\dragonfont\char31};%griffon
    \draw(6,0)+(0.5,0.5)node[yellow]{\dragonfont\char15}node[black]{\dragonfont\char16};%dragon
    \draw(10,0)+(0.5,0.5)node[yellow]{\dragonfont\char30}node[black]{\dragonfont\char31};%griffon
    %%%%
    \foreach\x in {0,2,4,6,8,10} {%
        \draw(\x,6)+(1.5,0.5)node[red]{\dragonfont\char0}node[black]{\dragonfont\char1};%sylph
    }%
    \draw(1,7)+(0.5,0.5)node[red]{\dragonfont\char30}node[black]{\dragonfont\char31};%griffon
    \draw(5,7)+(0.5,0.5)node[red]{\dragonfont\char15}node[black]{\dragonfont\char16};%dragon
    \draw(10,7)+(0.5,0.5)node[red]{\dragonfont\char30}node[black]{\dragonfont\char31};%griffon
}\\
\tikzchessboard{8}{12}{green}{%
    \foreach\x in {0,...,11} {%
        \draw(\x,1)+(0.5,0.5)node[yellow]{\dragonfont\char6}node[black]{\dragonfont\char7};%warrior
    }%
    \draw(0,0)+(0.5,0.5)node[yellow]{\dragonfont\char18}node[black]{\dragonfont\char19};%oliphant
    \draw(1,0)+(0.5,0.5)node[yellow]{\dragonfont\char27}node[black]{\dragonfont\char28};%unicorn
    \draw(2,0)+(0.5,0.5)node[yellow]{\dragonfont\char9}node[black]{\dragonfont\char10};%hero
    \draw(3,0)+(0.5,0.5)node[yellow]{\dragonfont\char33}node[black]{\dragonfont\char34};%thief
    \draw(4,0)+(0.5,0.5)node[yellow]{\dragonfont\char24}node[black]{\dragonfont\char25};%cleric
    \draw(5,0)+(0.5,0.5)node[yellow]{\dragonfont\char12}node[black]{\dragonfont\char13};%mage
    \draw(6,0)+(0.5,0.5)node[yellow]{\dragonfont\char21}node[black]{\dragonfont\char22};%king
    \draw(7,0)+(0.5,0.5)node[yellow]{\dragonfont\char3}node[black]{\dragonfont\char4};%paladin
    \draw(8,0)+(0.5,0.5)node[yellow]{\dragonfont\char33}node[black]{\dragonfont\char34};%thief
    \draw(9,0)+(0.5,0.5)node[yellow]{\dragonfont\char9}node[black]{\dragonfont\char10};%hero
    \draw(10,0)+(0.5,0.5)node[yellow]{\dragonfont\char27}node[black]{\dragonfont\char28};%unicorn
    \draw(11,0)+(0.5,0.5)node[yellow]{\dragonfont\char18}node[black]{\dragonfont\char19};%oliphant
    %%%%
    \foreach\x in {0,...,11} {%
        \draw(\x,6)+(0.5,0.5)node[red]{\dragonfont\char6}node[black]{\dragonfont\char7};%warrior
    }%
    \draw(0,7)+(0.5,0.5)node[red]{\dragonfont\char18}node[black]{\dragonfont\char19};%oliphant
    \draw(1,7)+(0.5,0.5)node[red]{\dragonfont\char27}node[black]{\dragonfont\char28};%unicorn
    \draw(2,7)+(0.5,0.5)node[red]{\dragonfont\char9}node[black]{\dragonfont\char10};%hero
    \draw(3,7)+(0.5,0.5)node[red]{\dragonfont\char33}node[black]{\dragonfont\char34};%thief
    \draw(4,7)+(0.5,0.5)node[red]{\dragonfont\char3}node[black]{\dragonfont\char4};%paladin
    \draw(5,7)+(0.5,0.5)node[red]{\dragonfont\char21}node[black]{\dragonfont\char22};%king
    \draw(6,7)+(0.5,0.5)node[red]{\dragonfont\char12}node[black]{\dragonfont\char13};%mage
    \draw(7,7)+(0.5,0.5)node[red]{\dragonfont\char24}node[black]{\dragonfont\char25};%cleric
    \draw(8,7)+(0.5,0.5)node[red]{\dragonfont\char33}node[black]{\dragonfont\char34};%thief
    \draw(9,7)+(0.5,0.5)node[red]{\dragonfont\char9}node[black]{\dragonfont\char10};%hero
    \draw(10,7)+(0.5,0.5)node[red]{\dragonfont\char27}node[black]{\dragonfont\char28};%unicorn
    \draw(11,7)+(0.5,0.5)node[red]{\dragonfont\char18}node[black]{\dragonfont\char19};%oliphant
}\\
\tikzchessboard{8}{12}{red}{%
    \foreach\x in {1,3,5,7,9,11} {%
        \draw(\x,1)+(0.5,0.5)node[yellow]{\dragonfont\char36}node[black]{\dragonfont\char37};%dwarf
    }%
    \draw(2,0)+(0.5,0.5)node[yellow]{\dragonfont\char39}node[black]{\dragonfont\char40};%basilisk
    \draw(6,0)+(0.5,0.5)node[yellow]{\dragonfont\char42}node[black]{\dragonfont\char43};%elemental
    \draw(9,0)+(0.5,0.5)node[yellow]{\dragonfont\char39}node[black]{\dragonfont\char40};%basilisk
    %%%%
    \foreach\x in {1,3,5,7,9,11} {%
        \draw(\x,6)+(-0.5,0.5)node[red]{\dragonfont\char36}node[black]{\dragonfont\char37};%dwarf
    }%
    \draw(2,7)+(0.5,0.5)node[red]{\dragonfont\char39}node[black]{\dragonfont\char40};%basilisk
    \draw(5,7)+(0.5,0.5)node[red]{\dragonfont\char42}node[black]{\dragonfont\char43};%elemental
    \draw(9,7)+(0.5,0.5)node[red]{\dragonfont\char39}node[black]{\dragonfont\char40};%basilisk
}\\
...
\draw(1,0)+(0.5,0.5)node[white]{\ahfont\char36}node[black]{\ahfont\char37};
...
\draw(10,0)+(0.5,0.5)node[white]{\ahfont\char36}node[black]{\ahfont\char37};
...
\draw(1,7)+(0.5,0.5)node[white]{\ahfont\char36}node[black]{\ahfont\char38};
...
\draw(10,7)+(0.5,0.5)node[white]{\ahfont\char36}node[black]{\ahfont\char38};
...
\draw(0,0)+(0.5,0.5)node[white]{\ahfont\char42}node[black]{\ahfont\char43};
\draw(1,0)+(0.5,0.5)node[white]{\ahfont\char18}node[black]{\ahfont\char19};
\draw(2,0)+(0.5,0.5)node[white]{\ahfont\char39}node[black]{\ahfont\char40};
\draw(3,0)+(0.5,0.5)node[white]{\ahfont\char45}node[black]{\ahfont\char46};
\draw(4,0)+(0.5,0.5)node[white]{\ahfont\char39}node[black]{\ahfont\char40};
\draw(5,0)+(0.5,0.5)node[white]{\ahfont\char3}node[black]{\ahfont\char4};
\draw(6,0)+(0.5,0.5)node[white]{\ahfont\char36}node[black]{\ahfont\char37};
\foreach\x in {1,...,7} {
    \draw(\x,5)+(-0.5,0.5)node[white]{\ahfont\char12}node[black]{\ahfont\char14};
}
\draw(0,6)+(0.5,0.5)node[white]{\ahfont\char42}node[black]{\ahfont\char44};
\draw(1,6)+(0.5,0.5)node[white]{\ahfont\char18}node[black]{\ahfont\char20};
\draw(2,6)+(0.5,0.5)node[white]{\ahfont\char39}node[black]{\ahfont\char41};
\draw(3,6)+(0.5,0.5)node[white]{\ahfont\char45}node[black]{\ahfont\char47};
\draw(4,6)+(0.5,0.5)node[white]{\ahfont\char39}node[black]{\ahfont\char41};
\draw(5,6)+(0.5,0.5)node[white]{\ahfont\char3}node[black]{\ahfont\char5};
\draw(6,6)+(0.5,0.5)node[white]{\ahfont\char36}node[black]{\ahfont\char38};
}
%%%%%%%%%%%%%%%%%%%%
