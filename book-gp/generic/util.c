          ...
          default:
            {
              ...
              if (strchr(buff, '*'))
              {
                switch (buff[l-1])
                {
                  case 'c':
                  case 'd':
                  case 'i': n += fprintf(f, buff, va_arg(ap, int), va_arg(ap, int)); break;
                  case 'o':
                  case 'x':
                  case 'X':
                  case 'u': n += fprintf(f, buff, va_arg(ap, int), va_arg(ap, unsigned int)); break;
                  case 'A':
                  case 'a':
                  case 'F':
                  case 'f':
                  ...
                  case 'g':
                  case 'E':
                  case 'e': n += fprintf(f, buff, va_arg(ap, int), va_arg(ap, double)); break;
                  case 's': n += fprintf(f, buff, va_arg(ap, int), va_arg(ap, const char*)); break;
                  case 'p': n += fprintf(f, buff, va_arg(ap, int), va_arg(ap, void*)); break;
                  case '%': n += fprintf(f, buff, va_arg(ap, int)); break;
                  case 'n': *(va_arg(ap, int*)) = n; break;
              ...
              else
              {
                switch (buff[l-1])
                {
                  case 'c':
                  case 'd':
                  case 'i': n += fprintf(f, buff, va_arg(ap, int)); break;
                  case 'o':
                  case 'x':
                  case 'X':
                  case 'u': n += fprintf(f, buff, va_arg(ap, unsigned int)); break;
                  case 'A':
                  case 'a':
                  case 'F':
                  case 'f':
                  ...
                  case 'g':
                  case 'E':
                  case 'e': n += fprintf(f, buff, va_arg(ap, double)); break;
                  case 's': n += fprintf(f, buff, va_arg(ap, const char*)); break;
                  case 'p': n += fprintf(f, buff, va_arg(ap, void*)); break;
                  case '%': n += fprintf(f, buff); break;
                  case 'n': *(va_arg(ap, int*)) = n; break;
                  default: fprintf(stderr, "***** UNSUPPORTED PRINTF CODE IN FSTATUS: %s *****\n", buff); break;
                }
              }
