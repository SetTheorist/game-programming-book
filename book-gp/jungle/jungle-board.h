#ifndef  JUNGLE_BOARD_H
#define  JUNGLE_BOARD_H

/* $Id: jungle-board.h,v 1.10 2010/01/16 17:03:36 apollo Exp apollo $ */
...
#define  SHOW_MOVES      0
#define  SHOW_MOVES_PV    0
#define  VALIDATE_HASH    1
#define  VALIDATE_MOVE_HASH  1
...
typedef enum piecet {
  rat, cat, dog, wolf, panther, lion, tiger, elephant,
  empty
} piecet;
...
typedef enum flagst {
  w_win=1, b_win=2, w_draw=4, b_draw=8, cap=16, nullmove=32
} flagst;
...
typedef struct eval_params {
  ...
  evalt   diag_penalty[8][8];
  evalt   protect_piece_bonus[8][8];
  evalt   protect_trap_bonus;
} eval_params;
